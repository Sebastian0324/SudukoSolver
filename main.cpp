...
void help() {
    ...
    std::cout << "  Ends the programm and closes the window" << std::endl;
    std::cout << std::endl << "/*-----Insert-----*/" << std::endl;
    std::cout << "  3 overloads: int int int, ex: insert 7 1 4" << std::endl;
    std::cout << "  The first number is the number you want to insert" << std::endl;
    std::cout << "  The secound number is the x-cord for that number (1 - 9)" << std::endl;
    std::cout << "  The third number is the y-cord for that number (1 - 9)" << std::endl;
    std::cout << std::endl << "/*-----Fill-----*/" << std::endl;
    std::cout << "  9 overloads: int" << std::endl;
    std::cout << "  When this command is called it takes the next 9 inputs and" << std::endl;
    std::cout << "  converts them into numbers and inserts them into the gameboard." << std::endl;
    std::cout << "  Each input chooed be length 9 and use the numbers 0 - 9. " << std::endl;
    std::cout << std::endl << "/*-----Solve-----*/" << std::endl;
    std::cout << "  0 overloads; loops through all tiles" << std::endl;
    std::cout << "  and checks inserts any forced numbers" << std::endl;
    std::cout << std::endl << "/*-----Logic-----*/" << std::endl;
    std::cout << "/*-----Weak and Broken-----*/" << std::endl;
    std::cout << std::endl << "/*-----Debug-----*/" << std::endl;
    std::cout << "  0 overloads: Outputs a list of all tiles, theire number and flags i: n | f" << std::endl;
    std::cout << "  2 overloads: int int, ex: debug 4 7" << std::endl;
    std::cout << "  runs debug 3 overloads: debug 4 7 1" << std::endl;
    std::cout << "  3 overloads: int int int" << std::endl;
    std::cout << "  The first number is the x-cord for that number (1 - 9)" << std::endl;
    std::cout << "  The secound number is the y-cord for that number (1 - 9)" << std::endl;
    std::cout << "  The third number the number you want informatin about (1 - 9)" << std::endl;
    std::cout << std::endl << "/*-----Print-----*/" << std::endl;
    std::cout << "  0 overloads: Prints a humen readebl vertion of the gameboard." << std::endl;
    std::cout << "  The output dose not contain debuginfo" << std::endl << std::endl;
}